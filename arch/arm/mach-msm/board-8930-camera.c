...
static struct msm_gpiomux_config msm8930_cam_common_configs[] = {
	...
	//MM-MC-RemoveUnnecessaryGPIO-00-{
	/*
	{
		.gpio = 107,
		.settings = {
	...
	*/
	...
	//MM-UW-fix high suspend current-00*{
    {
        .gpio = 95,
        .settings = {
            [GPIOMUX_ACTIVE]    = &cam_settings[2],
...
static struct gpio fih_common_cam_gpio[] = {
    //CAM_MCLK0
    {5, GPIOF_DIR_IN, "CAMIF_MCLK"},//MM-MC-BringUpCameraRawSensorS5k4e1-00+
    //CAM_MCLK1
    {4, GPIOF_DIR_IN, "CAMIF_MCLK"},//MM-MC-BringUpFrontCameraMT9V115-00+
    {20, GPIOF_DIR_IN, "CAMIF_I2C_DATA"},
    {21, GPIOF_DIR_IN, "CAMIF_I2C_CLK"},
};
...
//MM-MC-BringUpCameraRawSensorS5k4e1-00+{
    ...
    {77, GPIOF_DIR_OUT, "CAM_VGA_STBY"},/* MM-MC-FixMainCameraI2cBusy-00+ */
#endif
//MM-MC-BringUpCameraRawSensorS5k4e1-00+}
};
...
//MM-MC-BringUpCameraRawSensorS5k4e1-00+{
#if defined(CONFIG_S5K4E1) || defined(CONFIG_S5K4E1_2ND)|| defined(CONFIG_AR0543)//MM-MC-ImplementSlaveAddressSwitchMechanism-00*
    {77, GPIOF_OUT_INIT_HIGH, 10000},/* MM-MC-FixMainCameraI2cBusy-00+ */
    //Init all 5M pins
    {93, GPIOF_OUT_INIT_LOW, 0},
    {95, GPIOF_OUT_INIT_LOW, 0},
    {76, GPIOF_OUT_INIT_LOW, 0},
    {96, GPIOF_OUT_INIT_LOW, 10000},/* MM-MC-FixMainCameraI2cBusy-00* */
    //Power on
...
//---------------------------------------------------------------------------
//MM-MC-BringUpLM3642ForCameraFlashLed-00+{
...
//---------------------------------------------------------------------------
//MM-MC-BringUpCameraRawSensorS5k4e1For2ndSource-00*{
...
static struct msm_camera_sensor_info msm_camera_sensor_s5k4e1_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &msm_act_main_cam_fih_0_info,//MM-MC-ImplementCameraAutoFocusForS5K4E1-00+
};
#endif
//MM-MC-BringUpCameraRawSensorS5k4e1-00+}

//MM-MC-BringUpCameraRawSensorS5k4e1For2ndSource-00+{
//MM-MC-BringUpAD5823ForAF-01*{
...
//MM-UW-BringUpCameraRawSensorAR0543-00+{
#ifdef CONFIG_AR0543
...
static struct msm_camera_sensor_info msm_camera_sensor_ar0543_data = {
	...
	.camera_type = BACK_CAMERA_2D,
	.sensor_type = BAYER_SENSOR,
	.actuator_info = &msm_act_main_cam_fih_1_info,//MM-MC-BringUpAD5823ForAF-01*
};
#endif
//MM-UW-BringUpCameraRawSensorAR0543-00+}
...
//---------------------------------------------------------------------------
//MM-MC-BringUpCameraYUVSensorForHM03D5-00+{
#ifdef CONFIG_HM03D5
...
struct i2c_board_info msm8930_camera_i2c_boardinfo[] = {
    ...
    I2C_BOARD_INFO("ar0543", 0x6E),//MM-MC-ImplementSlaveAddressSwitchMechanism-00*
