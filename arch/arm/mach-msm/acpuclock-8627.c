...
/*	[0]  = { {  384000, PLL_8, 0, 0x00 },  LVL_LOW, 1050000, 1 },
	...
	[11] = { {  972000, HFPLL, 1, 0x24 }, LVL_HIGH, 1150000, 4 }, 	*/	//asli
	[0]  = { {  384000, PLL_8, 0, 0x00 },  LVL_LOW, 1050000, 1 },	//evokernel-start
	[1]  = { {  432000, HFPLL, 2, 0x20 },  LVL_NOM, 1050000, 1 },
	[2]  = { {  486000, HFPLL, 2, 0x24 },  LVL_NOM, 1050000, 1 },
	...
	[15] = { { 1188000, HFPLL, 1, 0x2C }, LVL_HIGH, 1150000, 4 },	//evokernel-end
	{ }
};
...
/*	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000 },
	...
	{ 1, {   972000, HFPLL, 1, 0x24 }, L2(11), 1100000 },	*/	//asli
	{ 1, {   384000, PLL_8, 0, 0x00 }, L2(0),   900000 },	//evokernel-start
	...
	{ 1, {  1188000, HFPLL, 1, 0x2C }, L2(11), 1125000 },	//evokernel-end
	{ 0, { 0 } }
};
